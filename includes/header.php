    ...
    <div class="wrapper">
      ...
      <!-- <nav class="main-header navbar navbar-expand navbar-dark"> -->
        ...
        <ul class="navbar-nav">
         ...
         <!--  <li class="nav-item d-none d-sm-inline-block">
            <a href="dashboard.php" class="nav-link">Complaint</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="dashboard.php" class="nav-link">Blotter</a>
          </li> -->
         <!--  <?php
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php
          $get = mysqli_query($conn, "SELECT * FROM complaint JOIN users ON complaint.added_by=users.user_Id WHERE complaint.is_read = 0");
          $count = mysqli_num_rows($get);
          
          ?>
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" style="font-size: 15px;">
              <i class="far fa-bell"></i>
              Complaint &nbsp;<span class="badge badge-warning navbar-badge" style="font-size: 13px;"><?php echo $count; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <span class="dropdown-item dropdown-header">
                <?php
                $message = ($count < 1) ? 'No complaints for today' : ($count == 1 ? $count . ' complaint notification' : $count . ' complaint notifications');
                echo $message;
                ?>
              </span>
              <div class="dropdown-divider"></div>
              ...
              ?>
              <a href="#" class="dropdown-item">
                <i class="fa-solid fa-circle-info mr-2"></i> <?php echo ucwords(substr($r_count['complaint_nature'], 0, 10)) . '...'; ?>
              ...
              <a type="button" href="mailbox_complaint.php" class="dropdown-item dropdown-footer">See Complaint</a>
              <?php elseif(mysqli_num_rows($get) > 1): ?>
              <a type="button" href="mailbox_complaint.php" class="dropdown-item dropdown-footer">See All Complaints</a>
              <?php endif; ?>
            </div>
          </li>
          ...
          <?php
          $get2 = mysqli_query($conn, "SELECT * FROM blotter JOIN users ON blotter.added_by=users.user_Id WHERE blotter.is_read = 0");
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" style="font-size: 15px;">
              ...
              Blotter &nbsp;<span class="badge badge-warning navbar-badge" style="font-size: 13px;"><?php echo $count2; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <span class="dropdown-item dropdown-header">
                <?php
                $message2 = ($count2 < 1) ? 'No blotters for today' : ($count2 == 1 ? $count2 . ' blotter notification' : $count2 . ' blotter notifications');
                echo $message2;
                ?>
              </span>
              <div class="dropdown-divider"></div>
              ...
              while ($r_count2 = mysqli_fetch_array($get2)) {
              ?>
              <a href="#" class="dropdown-item">
                <i class="fa-solid fa-circle-info mr-2"></i> <?php echo ucwords(substr($r_count2['incidentNature'], 0, 10)) . '...'; ?>
                <span class="float-right text-muted text-sm"><?php echo $r_count2['date_added']; ?></span>
              </a>
              <div class="dropdown-divider"></div>
              <?php
              }
              ...
              ?>
              <?php if(mysqli_num_rows($get2) == 1) : ?>
              <a type="button" href="mailbox_blotter.php" class="dropdown-item dropdown-footer">See Blotter</a>
              <?php elseif(mysqli_num_rows($get2) > 1): ?>
              <a type="button" href="mailbox_blotter.php" class="dropdown-item dropdown-footer">See All Blotters</a>
              <?php endif; ?>
            </div>
          </li>
