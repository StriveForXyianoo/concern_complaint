<title>Concern and Complaint Reporting System | Profile</title>
<?php
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="viewprofile">
                   <!--  <div class="form-group row">
                      <label for="First name" class="col-sm-2 col-form-label">Username</label>
                      <div class="col-sm-10">
                  ...
                  <div class="tab-pane" id="updateprofile">
                    <form action="process_update.php" method="POST">
                      ...
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">Full address</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <textarea name="address" class="form-control" id="" cols="30" rows="2" required><?php echo $row['address']; ?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
