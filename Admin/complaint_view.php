<title>Concern and Complaint Reporting System | Complaint images</title>
<?php
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Complaint images</li>
          </ol>
        </div>
      </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                ...
                <div class="mt-3">
                  ...
                  <p><strong>Nature of Complaint:</strong> <?= ucwords($row['complaint_nature']) ?></p>
                  <p><strong>Incident Location:</strong> <?= ucwords($row['incident_location']) ?></p>
                  <p><strong>Date Happened:</strong> <?= date('F j, Y', strtotime($row['date_happened'])) ?></p>
                  <p><strong>Time Happened:</strong> <?= date('h:i A', strtotime($row['time_happened'])) ?></p>
                  <p><strong>Witness:</strong> <?= ucwords($row['witness']) ?></p>
                  <p><strong>Details:</strong> <?= nl2br(ucwords($row['details'])) ?></p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="carousel-inner">
                    ...
                    echo '<div class="carousel-item ' . $activeClass . '">
                      <img class="d-block w-100" src="../images-complaints/' . $filename . '" alt="Blotter Image">
                    </div>';
                    }
                    ?>
                  </div>
