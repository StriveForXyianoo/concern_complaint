...
if(isset($_GET['export'])) {
  ...
  if($export == 'resident') {
      ...
      $officials = [
        ...
        $blotter = [
          ['No.', 'Complainant', 'Complainant contact', 'Complainant address', 'Incident Datetime', 'Incident Nature', 'Incident Address', 'Accused/Subject Person', 'Accused Address', 'Witnesses', 'Incident Description', 'Action Taken', 'Blotter Status', 'Date reported']
        ];
